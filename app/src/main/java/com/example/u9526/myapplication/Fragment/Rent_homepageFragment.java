...
import com.example.u9526.myapplication.Rent.rent_homepage__search___attribute;
...
//-------------------------------------------------------------------------------讀取代入判斷的資料
    ...
    private void Search_click() {
        Search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent search = new Intent(getActivity(), rent_homepage__search___attribute.class);
